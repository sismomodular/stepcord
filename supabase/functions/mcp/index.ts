...
var deviceCatalog_exports = {};
__export(deviceCatalog_exports, {
  CATALOG: () => CATALOG,
  CATALOG_BRANDS: () => CATALOG_BRANDS,
  CATALOG_BY_ID: () => CATALOG_BY_ID
});
var MIDI_STD, MIDI_FULL, AUDIO_OUT, AUDIO_IO, CV_GATE, SYNC_IO, c, CATALOG, CATALOG_BY_ID, CATALOG_BRANDS;
var init_deviceCatalog = __esm({
  "src/data/deviceCatalog.ts"() {
    init_define_import_meta_env();
    MIDI_STD = ["midi_in", "midi_out", "usb_midi"];
    MIDI_FULL = ["midi_in", "midi_out", "midi_thru", "usb_midi"];
    AUDIO_OUT = ["audio_out"];
    AUDIO_IO = ["audio_in", "audio_out"];
    CV_GATE = ["cv_in", "cv_out", "gate_in", "gate_out"];
    SYNC_IO = ["sync_in", "sync_out"];
    c = (...groups) => Array.from(new Set(groups.flat()));
    CATALOG = [
      // ───────────────────────── KORG ─────────────────────────
    ...
    CATALOG_BY_ID = Object.fromEntries(
      CATALOG.map((d) => [d.id, d])
    );
    CATALOG_BRANDS = Array.from(
      new Set(CATALOG.map((d) => d.brand))
    ).sort();
  }
});

// src/data/devicePower.ts
var devicePower_exports = {};
__export(devicePower_exports, {
  APPROVED_VOLTAGES: () => APPROVED_VOLTAGES,
  POLARITY_CONNECTOR_MATRIX: () => POLARITY_CONNECTOR_MATRIX,
  POWER_DB: () => POWER_DB,
  VOLTAGE_MAX: () => VOLTAGE_MAX,
  VOLTAGE_MIN: () => VOLTAGE_MIN
});
var APPROVED_VOLTAGES, VOLTAGE_MIN, VOLTAGE_MAX, POLARITY_CONNECTOR_MATRIX, POWER_DB;
var init_devicePower = __esm({
  "src/data/devicePower.ts"() {
    init_define_import_meta_env();
    APPROVED_VOLTAGES = [3.3, 5, 6, 7.5, 9, 12, 15, 18, 19, 24];
    VOLTAGE_MIN = 3.3;
    VOLTAGE_MAX = 24;
    ...
    POWER_DB = [
      ...
      { id: "korg-microkorg-2", brand: "Korg", model: "microKORG 2", power_voltage: 12, power_current_ma: 2e3, power_polarity: "center_positive", connector_type: "barrel_5.5x2.1" },
      ...
      { id: "korg-minilogue-xd", brand: "Korg", model: "minilogue xd", power_voltage: 12, power_current_ma: 2e3, power_polarity: "center_positive", connector_type: "barrel_5.5x2.1" },
      { id: "korg-prologue", brand: "Korg", model: "Prologue", power_voltage: 12, power_current_ma: 3e3, power_polarity: "center_positive", connector_type: "barrel_5.5x2.1" },
      // ───────── ROLAND ─────────
      { id: "roland-tr-8s", brand: "Roland", model: "TR-8S", power_voltage: 9, power_current_ma: 2e3, power_polarity: "center_positive", connector_type: "barrel_5.5x2.1" },
      { id: "roland-tr-6s", brand: "Roland", model: "TR-6S", power_voltage: 9, power_current_ma: 1e3, power_polarity: "center_positive", connector_type: "barrel_5.5x2.1" },
      { id: "roland-sp-404mkii", brand: "Roland", model: "SP-404MKII", power_voltage: 9, power_current_ma: 2e3, power_polarity: "center_positive", connector_type: "barrel_5.5x2.1" },
      { id: "roland-mc-101", brand: "Roland", model: "MC-101", power_voltage: 9, power_current_ma: 1e3, power_polarity: "center_positive", connector_type: "barrel_5.5x2.1" },
      { id: "roland-mc-707", brand: "Roland", model: "MC-707", power_voltage: 9, power_current_ma: 2e3, power_polarity: "center_positive", connector_type: "barrel_5.5x2.1" },
      { id: "roland-aira-compact", brand: "Roland", model: "AIRA Compact series", power_voltage: 5, power_current_ma: 1e3, power_polarity: "usb_c_pd", connector_type: "usb_c" },
      ...
      { id: "roland-sh-4d", brand: "Roland", model: "SH-4d", power_voltage: 9, power_current_ma: 3e3, power_polarity: "center_positive", connector_type: "barrel_5.5x2.1" },
      // ───────── BEHRINGER ─────────
      { id: "beh-model-d", brand: "Behringer", model: "Model D", power_voltage: 12, power_current_ma: 1e3, power_polarity: "center_positive", connector_type: "barrel_5.5x2.1" },
      { id: "beh-neutron", brand: "Behringer", model: "Neutron", power_voltage: 12, power_current_ma: 1e3, power_polarity: "center_positive", connector_type: "barrel_5.5x2.1" },
      { id: "beh-poly-d", brand: "Behringer", model: "Poly D", power_voltage: 12, power_current_ma: 2e3, power_polarity: "center_positive", connector_type: "barrel_5.5x2.1" },
      ...
      { id: "beh-crave", brand: "Behringer", model: "Crave", power_voltage: 12, power_current_ma: 1e3, power_polarity: "center_positive", connector_type: "barrel_5.5x2.1" },
      // ───────── ELEKTRON ─────────
      { id: "elek-digitakt-ii", brand: "Elektron", model: "Digitakt II", power_voltage: 12, power_current_ma: 2e3, power_polarity: "center_positive", connector_type: "barrel_5.5x2.1" },
      { id: "elek-digitone-ii", brand: "Elektron", model: "Digitone II", power_voltage: 12, power_current_ma: 2e3, power_polarity: "center_positive", connector_type: "barrel_5.5x2.1" },
      { id: "elek-syntakt", brand: "Elektron", model: "Syntakt", power_voltage: 12, power_current_ma: 2e3, power_polarity: "center_positive", connector_type: "barrel_5.5x2.1" },
      { id: "elek-a4-mkii", brand: "Elektron", model: "Analog Four MKII", power_voltage: 12, power_current_ma: 2e3, power_polarity: "center_positive", connector_type: "barrel_5.5x2.1" },
      { id: "elek-rytm-mkii", brand: "Elektron", model: "Analog Rytm MKII", power_voltage: 12, power_current_ma: 2e3, power_polarity: "center_positive", connector_type: "barrel_5.5x2.1" },
      { id: "elek-model-cycles", brand: "Elektron", model: "Model:Cycles", power_voltage: 5, power_current_ma: 1e3, power_polarity: "usb_c_pd", connector_type: "usb_c" },
      { id: "elek-model-samples", brand: "Elektron", model: "Model:Samples", power_voltage: 5, power_current_ma: 1e3, power_polarity: "usb_c_pd", connector_type: "usb_c" },
      { id: "elek-octatrack-mkiii", brand: "Elektron", model: "Octatrack MKIII", power_voltage: 12, power_current_ma: 2e3, power_polarity: "center_positive", connector_type: "barrel_5.5x2.1" },
      // ───────── MOOG ─────────
      ...
      { id: "moog-grandmother", brand: "Moog", model: "Grandmother", power_voltage: 12, power_current_ma: 2e3, power_polarity: "center_positive", connector_type: "barrel_5.5x2.5" },
      ...
      // ───────── ARTURIA ─────────
      { id: "art-minifreak", brand: "Arturia", model: "MiniFreak", power_voltage: 12, power_current_ma: 2e3, power_polarity: "center_positive", connector_type: "barrel_5.5x2.1" },
      ...
      { id: "art-drumbrute-impact", brand: "Arturia", model: "DrumBrute Impact", power_voltage: 12, power_current_ma: 1e3, power_polarity: "center_positive", connector_type: "barrel_5.5x2.1" },
      ...
      // ───────── TEENAGE ENGINEERING ─────────
      { id: "te-op-1-field", brand: "Teenage Engineering", model: "OP-1 Field", power_voltage: 5, power_current_ma: 2e3, power_polarity: "usb_c_pd", connector_type: "usb_c" },
      { id: "te-op-z", brand: "Teenage Engineering", model: "OP-Z", power_voltage: 5, power_current_ma: 1e3, power_polarity: "usb_c_pd", connector_type: "usb_c" },
      ...
      { id: "nov-bass-station-ii", brand: "Novation", model: "Bass Station II", power_voltage: 9, power_current_ma: 1e3, power_polarity: "center_positive", connector_type: "barrel_5.5x2.1" },
      { id: "nov-circuit-rhythm", brand: "Novation", model: "Circuit Rhythm", power_voltage: 9, power_current_ma: 1e3, power_polarity: "center_positive", connector_type: "barrel_5.5x2.1" },
      { id: "nov-circuit-tracks", brand: "Novation", model: "Circuit Tracks", power_voltage: 9, power_current_ma: 1e3, power_polarity: "center_positive", connector_type: "barrel_5.5x2.1" },
      // ───────── NATIVE INSTRUMENTS ─────────
      ...
      { id: "ni-maschine-mk3", brand: "Native Instruments", model: "Maschine MK3", power_voltage: 12, power_current_ma: 2e3, power_polarity: "center_positive", connector_type: "barrel_5.5x2.1" },
      // ───────── SEQUENTIAL ─────────
      ...
      { id: "seq-take-5", brand: "Sequential", model: "Take 5", power_voltage: 12, power_current_ma: 3e3, power_polarity: "center_positive", connector_type: "barrel_5.5x2.1" },
      ...
      { id: "korg-multipoly", brand: "Korg", model: "multi/poly", power_voltage: 12, power_current_ma: 2e3, power_polarity: "center_positive", connector_type: "barrel_5.5x2.1" },
      // Roland AIRA Compact individual units
      { id: "roland-aira-t-8", brand: "Roland", model: "AIRA Compact T-8", power_voltage: 5, power_current_ma: 1e3, power_polarity: "usb_c_pd", connector_type: "usb_c" },
      { id: "roland-aira-j-6", brand: "Roland", model: "AIRA Compact J-6", power_voltage: 5, power_current_ma: 1e3, power_polarity: "usb_c_pd", connector_type: "usb_c" },
      { id: "roland-aira-p-6", brand: "Roland", model: "AIRA Compact P-6", power_voltage: 5, power_current_ma: 1e3, power_polarity: "usb_c_pd", connector_type: "usb_c" },
      { id: "roland-aira-e-4", brand: "Roland", model: "AIRA Compact E-4", power_voltage: 5, power_current_ma: 1e3, power_polarity: "usb_c_pd", connector_type: "usb_c" },
      // Behringer additions
      { id: "beh-ub-xa-d", brand: "Behringer", model: "UB-Xa D", power_voltage: 12, power_current_ma: 2e3, power_polarity: "center_positive", connector_type: "barrel_5.5x2.1" },
      ...
      { id: "beh-kobol-expander", brand: "Behringer", model: "Kobol Expander", power_voltage: 12, power_current_ma: 1e3, power_polarity: "center_positive", connector_type: "barrel_5.5x2.1" },
      // Arturia
      { id: "art-astrolab-37", brand: "Arturia", model: "AstroLab 37", power_voltage: 12, power_current_ma: 2e3, power_polarity: "center_positive", connector_type: "barrel_5.5x2.1" },
      // Novation
      { id: "nov-mininova", brand: "Novation", model: "MiniNova", power_voltage: 12, power_current_ma: 2e3, power_polarity: "center_positive", connector_type: "barrel_5.5x2.1" },
      // Native Instruments
      { id: "ni-maschine-mikro-mk3", brand: "Native Instruments", model: "Maschine Mikro MK3", power_voltage: 5, power_current_ma: 1e3, power_polarity: "usb_c_pd", connector_type: "usb_c" },
      // Akai
      { id: "akai-mpc-key-37-g2", brand: "Akai", model: "MPC Key 37 G2", power_voltage: 12, power_current_ma: 3e3, power_polarity: "center_positive", connector_type: "barrel_5.5x2.1" },
      { id: "akai-mpc-key-37", brand: "Akai", model: "MPC Key 37", power_voltage: 12, power_current_ma: 3e3, power_polarity: "center_positive", connector_type: "barrel_5.5x2.1" },
      { id: "akai-mpc-one-plus", brand: "Akai", model: "MPC One+", power_voltage: 12, power_current_ma: 2e3, power_polarity: "center_positive", connector_type: "barrel_5.5x2.1" },
      { id: "akai-mpc-live-ii", brand: "Akai", model: "MPC Live II", power_voltage: 12, power_current_ma: 3e3, power_polarity: "center_positive", connector_type: "barrel_5.5x2.1" },
      { id: "akai-mpc-sample", brand: "Akai", model: "MPC Sample", power_voltage: 5, power_current_ma: 1e3, power_polarity: "usb_c_pd", connector_type: "usb_c" },
      // Waldorf
      { id: "wal-blofeld", brand: "Waldorf", model: "Blofeld", power_voltage: 12, power_current_ma: 1e3, power_polarity: "center_positive", connector_type: "barrel_5.5x2.1" },
      { id: "wal-protein", brand: "Waldorf", model: "Protein", power_voltage: 12, power_current_ma: 1e3, power_polarity: "center_positive", connector_type: "barrel_5.5x2.1" },
      // Polyend
      { id: "pol-play-plus", brand: "Polyend", model: "Play+", power_voltage: 9, power_current_ma: 2e3, power_polarity: "center_positive", connector_type: "barrel_5.5x2.1" },
      { id: "pol-tracker-plus", brand: "Polyend", model: "Tracker+", power_voltage: 9, power_current_ma: 1e3, power_polarity: "center_positive", connector_type: "barrel_5.5x2.1" },
      ...
      // Ableton
      { id: "abl-move", brand: "Ableton", model: "Move", power_voltage: 5, power_current_ma: 2e3, power_polarity: "usb_c_pd", connector_type: "usb_c" }
    ];
  }
});
...
// src/lib/mcp/tools/search-devices.ts
init_define_import_meta_env();
import { defineTool } from "npm:@lovable.dev/mcp-js@0.20.0";
import { z } from "npm:zod@^4.4.3";
var search_devices_default = defineTool({
  name: "search_devices",
  title: "Search device catalog",
  description: "Search the Stepcord catalog of synthesizers, drum machines, samplers, grooveboxes and modular gear by brand, model, category, type or tag.",
  inputSchema: {
    query: z.string().optional().describe("Free-text search over brand, model and tags."),
  ...
  handler: async ({ query, brand, category, limit }) => {
    const { CATALOG: CATALOG2 } = await Promise.resolve().then(() => (init_deviceCatalog(), deviceCatalog_exports));
    const q = query?.toLowerCase().trim();
    const results = CATALOG2.filter((d) => {
...
// src/lib/mcp/tools/get-device.ts
init_define_import_meta_env();
import { defineTool as defineTool2 } from "npm:@lovable.dev/mcp-js@0.20.0";
import { z as z2 } from "npm:zod@^4.4.3";
var get_device_default = defineTool2({
  name: "get_device",
  ...
  inputSchema: { id: z2.string().min(1).describe("Catalog device id.") },
  annotations: { readOnlyHint: true, idempotentHint: true, openWorldHint: false },
  handler: async ({ id }) => {
    const { CATALOG_BY_ID: CATALOG_BY_ID2 } = await Promise.resolve().then(() => (init_deviceCatalog(), deviceCatalog_exports));
    const device = CATALOG_BY_ID2[id];
    if (!device) {
...
// src/lib/mcp/tools/get-power-spec.ts
init_define_import_meta_env();
import { defineTool as defineTool3 } from "npm:@lovable.dev/mcp-js@0.20.0";
import { z as z3 } from "npm:zod@^4.4.3";
var get_power_spec_default = defineTool3({
  name: "get_power_spec",
  title: "Get device power spec",
  description: "Return the audited DC power spec (voltage, current, polarity, connector) for a device. Data used by Stepcord's safety guard \u2014 never power hardware from unaudited values.",
  inputSchema: {
    query: z3.string().min(1).describe("Device id, or 'Brand Model' text (e.g. 'Moog Mother-32').")
  },
  annotations: { readOnlyHint: true, idempotentHint: true, openWorldHint: false },
  handler: async ({ query }) => {
    const { POWER_DB: POWER_DB2 } = await Promise.resolve().then(() => (init_devicePower(), devicePower_exports));
    const q = query.toLowerCase().trim();
    const match = POWER_DB2.find((p) => p.id.toLowerCase() === q) ?? POWER_DB2.find((p) => `${p.brand} ${p.model}`.toLowerCase() === q) ?? POWER_DB2.find((p) => `${p.brand} ${p.model}`.toLowerCase().includes(q));
    if (!match) {
...
// src/lib/mcp/index.ts
var projectRef = "tvihdgxtoubmeqmvymyk";
var mcp_default = defineMcp({
  name: "stepcord-mcp",
  title: "Stepcord MCP",
  version: "0.1.0",
  instructions: "Tools for the Stepcord device catalog and power-safety database. Use `search_devices` to browse synths, drum machines, samplers and grooveboxes, `get_device` for full details, and `get_power_spec` for audited DC voltage/polarity/connector info.",
  auth: auth.oauth.issuer({
    issuer: `https://${projectRef}.supabase.co/auth/v1`,
    acceptedAudiences: "authenticated"
  }),
  tools: [search_devices_default, get_device_default, get_power_spec_default]
});
