...
export const DEVICES: MusicalDevice[] = [
  ...
  { name: "JD-Xi Synth",            brand: "Roland",            voltage:  9.0, current: 2.0, defaultPolarity: "center-negative", polarityLabel: "USE INVERTER C-" },
  { name: "Volca Series",           brand: "Korg",              voltage:  9.0, current: 1.7, defaultPolarity: "center-negative", polarityLabel: "USE INVERTER C-" },
