...
export const DEVICES: MusicalDevice[] = [
  ...
  { name: "SP-404 MKII",            brand: "Roland",            voltage:  5.7, current: 2.0, defaultPolarity: "center-negative", polarityLabel: "USE INVERTER C-" },
  ...
  { name: "JD-Xi Synth",            brand: "Roland",            voltage:  5.7, current: 2.0, defaultPolarity: "center-negative", polarityLabel: "USE INVERTER C-" },
  ...
  { name: "MicroKorg",              brand: "Korg",              voltage:  9.0, current: 0.6, defaultPolarity: "center-negative", polarityLabel: "USE INVERTER C-" },
